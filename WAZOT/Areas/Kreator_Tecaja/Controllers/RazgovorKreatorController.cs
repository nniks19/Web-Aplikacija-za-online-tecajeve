...
{
    [Area("Kreator_Tecaja")]
    public class RazgovorKreatorController : Controller
    {
        private readonly IUnitOfWork _unitOfWork;
        public RazgovorKreatorController(IUnitOfWork unitOfWork)
        {
        ...
        public IActionResult Pregled(int? id)
        {
            ...
            var osoba = _unitOfWork.Osoba.GetAll().Where(x => x.Oib == razgovorVM.Razgovor.PosiljateljOsobaOib).First();
