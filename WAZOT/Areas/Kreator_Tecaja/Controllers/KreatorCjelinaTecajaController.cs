...
{
    [Area("Kreator_Tecaja")]
    public class KreatorCjelinaTecajaController : Controller
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IWebHostEnvironment _hostEnvironment;


        public KreatorCjelinaTecajaController(IUnitOfWork unitOfWork, IWebHostEnvironment hostEnvironment)
        {
